...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("technical_claims", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("data_points", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("sources_referenced", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
    ...
    op.create_table(
        ...
        sa.Column("source_post_ids", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
